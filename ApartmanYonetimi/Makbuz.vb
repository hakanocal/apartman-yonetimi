...
Public Class Makbuz
    ...
    Private Sub Makbuz_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Label10.Text = "YALNIZ " + (Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(8).Value.ToString()) + " LİRA SAYIN " + (Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(7).Value.ToString()) + " 'dan ALINMIŞTIR. (" + (Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(9).Value.ToString()) + ")"
        'NÜSHA 2
        Label39.Text = AnaSayfa.Label6.Text
        Label32.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(0).Value
        Label45.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(1).Value
        Label46.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(2).Value
        Label42.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(3).Value
        Label35.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(4).Value
        Label33.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(5).Value
        Label31.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(6).Value
        Label26.Text = Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(7).Value
        Label38.Text = "YALNIZ " + (Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(8).Value.ToString()) + " LİRA SAYIN " + (Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(7).Value.ToString()) + " 'dan ALINMIŞTIR. (" + (Borclandir_islem.BunifuCustomDataGrid1.Rows(Borclandir_islem.rowIndex2).Cells(9).Value.ToString()) + ")"
